<?php
/**
 * This file contains the class Invalid_Assertion_Exception
 * This exception is thrown when we are unable to process the Assertion
 *
 ...
 */
class Invalid_Assertion_Exception extends Exception {
