<?php
/**
 * This file contains the class Invalid_XML_Exception
...
/**
 * This exception indicates that the received XML is incorrect or malformed.
 */
class Invalid_XML_Exception extends Exception {
