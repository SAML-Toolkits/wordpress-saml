<?php
/**
 * This file contains the class Blacklisted_User_Exception
 *
...
/**
 * This exception indicates that the user is blacklisted.
 */
class Blacklisted_User_Exception extends Exception {
	/**
