<?php
/**
 * This file contains the class Attribute_Restriction_Exception
 *
...
/**
 * This exception indicates that the user is whitelisted.
 */
class Attribute_Restriction_Exception extends Exception {
	/**
