<?php
/**
 * This file contains the class User_Creation_Failed_Exception
 *
...
/**
 * This exception indicates that the user creation failed.
 */
class User_Creation_Failed_Exception extends Exception {
	/**
