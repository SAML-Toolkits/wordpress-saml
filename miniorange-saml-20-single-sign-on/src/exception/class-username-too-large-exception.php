<?php
/**
 * This file contains the class Username_Too_Large_Exception
 *
...
/**
 * This exception indicates that the username is too large.
 */
class Username_Too_Large_Exception extends Exception {
	/**
