<?php
/**
 * Base Auto Redirection Data Handler.
 *
 ...
 * Base Auto Redirection Data Handler.
 */
class Site_Auto_Redirection_Data_Handler implements Form_Data_Handler_Interface {
	 ...
	 * @var string
	 */
	public $site_auto_redirection_option = 'default_idp';

	/**
	 * Is site auto redirection option default.
	 *
	 * @var boolean
	 */
	protected $is_site_auto_redirection_option_default = true;
