<?php
	...
	function plugin_setting_string_onelogin_saml_advanced_settings_sp_x509cert() {
		...
		echo '</textarea>';
		echo '<p class="description">'.__('Public x509 certificate of the SP. Leave this field empty if you gonna provide the private key by the sp.crt', 'onelogin-saml-sso');
	}
	...
	function plugin_section_customize_links_text() {
		echo "<p>".__("When we enable the SAML SSO to be integrated with a IdP some Wordpress links as 'user registration' or 'lost password' have no sense. Set here new urls in order to redirect the user to those url when executing those actions", 'onelogin-saml-sso')."</p>";
	}
